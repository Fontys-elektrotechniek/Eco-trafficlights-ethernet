...
typedef enum
{
    ...
    //
    TCPIP_EV_STACK_PROCESSED= (TCPIP_EV_TXDONE|TCPIP_EV_PKTPEND|TCPIP_EV_TICK),  // all events processed by the stack
    //  
 ...
 *
 * Note:            - There's no acknowledge needed for the normal transfer events: TCPIP_EV_TXDONE, TCPIP_EV_PKTPEND and TCPIP_EV_TICK;
 ...
 *                    TCPIP_EV_RXBUFNA, TCPIP_EV_TXABORT, TCPIP_EV_RXACT, TCPIP_EV_RXDONE).
