...
// C32 and C18 already has a ultoa() function that more-or-less matches this one
// C30 < v3.25 need this function
#if (defined (__C30__) && (__C30_VERSION__ < 325)) || defined(__C30_LEGACY_LIBC__)
void ultoa(DWORD Value, BYTE* Buffer)
{
	BYTE i;
	DWORD Digit;
