...
#if !defined(MAC_EMBEDDED_PIC32) && !defined(MAC_ENC28J60)
    #error "Either MAC_EMBEDDED_PIC32 or MAC_ENC28J60 have to be defined in hardware_profile.h!"
#endif

#if ( ((__PIC32_FEATURE_SET__ < 500) || (__PIC32_FEATURE_SET__ > 799) || !defined (_ETH)) && defined(MAC_EMBEDDED_PIC32) )
    #error "MAC_EMBEDDED_PIC32 is not supported on this processor. Select only MAC_ENC28J60 in hardware_profile.h!"
#endif

// MAC_EMBEDDED_PIC32 and MAC_ENC28J60 supported
...
#elif defined(MAC_ENC28J60)
    #undef  _EMBEDDED_ETHC
    #undef  _MAC_ENC28J60
    #define _MAC_ENC28J60
#endif
