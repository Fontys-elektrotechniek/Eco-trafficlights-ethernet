...
static eEthRxFilters        _stackRxFilters=(ETH_FILT_CRC_ERR_REJECT|ETH_FILT_RUNT_REJECT|ETH_FILT_ME_UCAST_ACCEPT|ETH_FILT_MCAST_ACCEPT|ETH_FILT_BCAST_ACCEPT);
...
int MACInit(int waitComplete)
{
    ...
    while(1)
    {
        ...
        EthRxFiltersSet(_stackRxFilters);
...
#ifdef _EMBEDDED_ETHC
                pNetPkt->PktTotLen=pktSize;
                pNetPkt->PktChecksum=pRxPktStat->pktChecksum;                
#endif                
