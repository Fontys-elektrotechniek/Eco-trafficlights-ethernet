...
// extra private flags, internal to this implementation
#define KEEP_ALIVE_PKT  0x1000      // the packet to be transmitted is a keep alive packet
#define USE_PARENT_PORT 0x2000      // use the parent local port, if available
