 ...
 * Rob van Eldijk		01/28/2010	Added Digilent Inc Cerebot 32MX4 Board Options
 ********************************************************************/
...
#define STACK_USE_NBNS					// NetBIOS Name Service Server for repsonding to NBNS fname broadcast queries
...
#define MY_DEFAULT_PRIMARY_DNS_BYTE3	(50ul)
